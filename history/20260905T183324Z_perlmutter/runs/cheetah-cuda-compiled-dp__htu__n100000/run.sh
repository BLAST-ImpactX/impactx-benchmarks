#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp / htu / n=100000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp__htu__n100000/cheetah__htu.py
