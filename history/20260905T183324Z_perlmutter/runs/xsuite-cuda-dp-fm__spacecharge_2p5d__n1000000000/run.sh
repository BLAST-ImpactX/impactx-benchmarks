#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / spacecharge_2p5d / n=1000000000
#   status: oom   layout: 1r x 1t   env: xsuite-gpu   device: cuda   precision: double
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__spacecharge_2p5d__n1000000000/xsuite__spacecharge_2p5d.py
