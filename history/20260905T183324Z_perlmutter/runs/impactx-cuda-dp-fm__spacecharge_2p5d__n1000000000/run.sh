#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp-fm / spacecharge_2p5d / n=1000000000
#   status: failed   layout: 1r x 1t   env: impactx-cuda-dp-fm   device: cuda   precision: double
...
exec pixi run --environment impactx-cuda-dp-fm python runs/perlmutter/impactx-cuda-dp-fm__spacecharge_2p5d__n1000000000/impactx__spacecharge_2p5d.py
