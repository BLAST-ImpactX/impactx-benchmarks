#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp / fodo_chromatic / n=16000000
...
exec pixi run --environment impactx-cuda-sp python runs/perlmutter/impactx-cuda-sp__fodo_chromatic__n16000000/impactx__fodo_chromatic.py
