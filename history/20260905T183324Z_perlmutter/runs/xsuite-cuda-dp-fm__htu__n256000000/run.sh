#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / htu / n=256000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__htu__n256000000/xsuite__htu.py
