#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp-fm / htu / n=64000000
...
exec pixi run --environment impactx-cuda-dp-fm python runs/perlmutter/impactx-cuda-dp-fm__htu__n64000000/impactx__htu.py
