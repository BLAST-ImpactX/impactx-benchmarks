#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp-fm / htu / n=64000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-sp-fm__htu__n64000000/cheetah__htu.py
