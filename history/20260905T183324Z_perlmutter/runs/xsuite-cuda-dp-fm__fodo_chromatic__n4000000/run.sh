#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / fodo_chromatic / n=4000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__fodo_chromatic__n4000000/xsuite__fodo_chromatic.py
