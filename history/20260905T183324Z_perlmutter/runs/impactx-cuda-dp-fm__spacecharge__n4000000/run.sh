#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp-fm / spacecharge / n=4000000
...
exec pixi run --environment impactx-cuda-dp-fm python runs/perlmutter/impactx-cuda-dp-fm__spacecharge__n4000000/impactx__spacecharge.py
