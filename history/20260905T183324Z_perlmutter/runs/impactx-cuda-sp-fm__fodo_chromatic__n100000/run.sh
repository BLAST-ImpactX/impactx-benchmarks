#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp-fm / fodo_chromatic / n=100000
...
exec pixi run --environment impactx-cuda-sp-fm python runs/perlmutter/impactx-cuda-sp-fm__fodo_chromatic__n100000/impactx__fodo_chromatic.py
