#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-dp / spacecharge / n=100000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-dp__spacecharge__n100000/cheetah__spacecharge.py
