#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp / spacecharge / n=256000000
...
exec pixi run --environment impactx-cuda-sp python runs/perlmutter/impactx-cuda-sp__spacecharge__n256000000/impactx__spacecharge.py
