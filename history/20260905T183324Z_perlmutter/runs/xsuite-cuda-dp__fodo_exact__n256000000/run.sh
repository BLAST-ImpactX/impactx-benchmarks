#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp / fodo_exact / n=256000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp__fodo_exact__n256000000/xsuite__fodo_exact.py
