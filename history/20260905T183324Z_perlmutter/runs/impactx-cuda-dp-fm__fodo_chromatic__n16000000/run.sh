#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp-fm / fodo_chromatic / n=16000000
...
exec pixi run --environment impactx-cuda-dp-fm python runs/perlmutter/impactx-cuda-dp-fm__fodo_chromatic__n16000000/impactx__fodo_chromatic.py
