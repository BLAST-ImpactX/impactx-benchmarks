#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp-fm / spacecharge / n=1000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-sp-fm__spacecharge__n1000000/cheetah__spacecharge.py
