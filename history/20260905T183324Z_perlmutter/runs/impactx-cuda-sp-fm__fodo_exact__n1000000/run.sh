#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp-fm / fodo_exact / n=1000000
...
exec pixi run --environment impactx-cuda-sp-fm python runs/perlmutter/impactx-cuda-sp-fm__fodo_exact__n1000000/impactx__fodo_exact.py
