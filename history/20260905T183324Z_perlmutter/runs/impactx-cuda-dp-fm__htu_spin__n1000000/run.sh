#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp-fm / htu_spin / n=1000000
...
exec pixi run --environment impactx-cuda-dp-fm python runs/perlmutter/impactx-cuda-dp-fm__htu_spin__n1000000/impactx__htu_spin.py
