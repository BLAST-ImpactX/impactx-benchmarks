#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp / fodo_exact / n=64000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-sp__fodo_exact__n64000000/cheetah__fodo_exact.py
