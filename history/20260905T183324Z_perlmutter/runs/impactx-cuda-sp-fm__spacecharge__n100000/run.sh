#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp-fm / spacecharge / n=100000
...
exec pixi run --environment impactx-cuda-sp-fm python runs/perlmutter/impactx-cuda-sp-fm__spacecharge__n100000/impactx__spacecharge.py
