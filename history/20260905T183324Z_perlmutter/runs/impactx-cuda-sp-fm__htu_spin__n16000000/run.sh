#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp-fm / htu_spin / n=16000000
...
exec pixi run --environment impactx-cuda-sp-fm python runs/perlmutter/impactx-cuda-sp-fm__htu_spin__n16000000/impactx__htu_spin.py
