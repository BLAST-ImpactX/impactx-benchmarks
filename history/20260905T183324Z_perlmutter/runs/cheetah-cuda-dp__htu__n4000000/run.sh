#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-dp / htu / n=4000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-dp__htu__n4000000/cheetah__htu.py
