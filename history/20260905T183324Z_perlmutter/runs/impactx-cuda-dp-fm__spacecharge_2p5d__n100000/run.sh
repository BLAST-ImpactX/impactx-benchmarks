#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp-fm / spacecharge_2p5d / n=100000
...
exec pixi run --environment impactx-cuda-dp-fm python runs/perlmutter/impactx-cuda-dp-fm__spacecharge_2p5d__n100000/impactx__spacecharge_2p5d.py
