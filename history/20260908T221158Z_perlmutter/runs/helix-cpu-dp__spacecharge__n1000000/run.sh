#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cpu-dp / spacecharge / n=1000000
#   status: supported   layout: 1r x 16t   env: helix   device: cpu   precision: double
