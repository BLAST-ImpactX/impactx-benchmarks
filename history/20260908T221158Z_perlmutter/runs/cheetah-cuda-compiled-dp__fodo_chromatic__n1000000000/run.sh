#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp / fodo_chromatic / n=1000000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp__fodo_chromatic__n1000000000/cheetah__fodo_chromatic.py
