#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cpu-dp / spacecharge / n=100000
#   status: supported   layout: 1r x 32t   env: helix   device: cpu   precision: double
