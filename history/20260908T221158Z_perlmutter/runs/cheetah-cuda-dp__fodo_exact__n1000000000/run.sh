#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-dp / fodo_exact / n=1000000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-dp__fodo_exact__n1000000000/cheetah__fodo_exact.py
