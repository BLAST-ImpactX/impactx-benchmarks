#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp / htu / n=64000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp__htu__n64000000/xsuite__htu.py
