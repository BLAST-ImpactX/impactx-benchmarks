#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / fodo_exact / n=16000000
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__fodo_exact__n16000000/synergia__fodo_exact.py
