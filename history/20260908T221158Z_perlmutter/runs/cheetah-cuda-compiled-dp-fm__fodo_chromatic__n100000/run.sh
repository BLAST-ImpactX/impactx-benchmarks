#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp-fm / fodo_chromatic / n=100000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp-fm__fodo_chromatic__n100000/cheetah__fodo_chromatic.py
