#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / fodo_chromatic / n=1000000
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__fodo_chromatic__n1000000/impactx__fodo_chromatic.py
