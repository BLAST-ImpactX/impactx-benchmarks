...
exec pixi run --environment elegant python /home/axel/src/impactx-benchmarks/codes/elegant/driver.py runs/axel-dell/elegant-cpu-dp__fodo_exact__n10000/elegant__fodo_exact.ele --ranks 4 --threads 1 --cpus 0,2,4,6 --device cpu
