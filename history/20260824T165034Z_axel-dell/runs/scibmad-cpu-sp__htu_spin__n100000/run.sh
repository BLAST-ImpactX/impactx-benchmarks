...
exec pixi run --environment scibmad taskset -c 0,2,4,6 julia -t4 --project=codes/scibmad runs/axel-dell/scibmad-cpu-sp__htu_spin__n100000/scibmad__htu_spin.jl
