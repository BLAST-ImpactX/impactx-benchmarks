...
exec pixi run --environment impactx-fm taskset -c 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-dp-fm__spacecharge_2p5d__n1000/impactx__spacecharge_2p5d.py
