...
#   status: supported   layout: 1r x 2t   env: xsuite   device: cpu   precision: double
...
exec pixi run --environment xsuite taskset -c 0,2,4,6 python runs/axel-dell/xsuite-cpu-dp-fm__fodo_chromatic__n1000/xsuite__fodo_chromatic.py
