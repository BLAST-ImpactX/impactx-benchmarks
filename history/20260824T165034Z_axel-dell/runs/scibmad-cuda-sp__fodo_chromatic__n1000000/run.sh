...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/axel-dell/scibmad-cuda-sp__fodo_chromatic__n1000000/scibmad__fodo_chromatic.jl
