...
exec pixi run --environment pyorbit mpirun -np 4 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 1 0,2,4,6 python runs/axel-dell/pyorbit-cpu-dp__spacecharge_2p5d__n1000000/pyorbit__spacecharge_2p5d.py
