#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cpu-simd-sp-fm / spacecharge_2p5d / n=1000
#   status: supported   layout: 1r x 4t   env: impactx-sp-fm   device: cpu   precision: single
...
exec pixi run --environment impactx-sp-fm taskset -c 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-sp-fm__spacecharge_2p5d__n1000/impactx__spacecharge_2p5d.py
