#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / htu / n=1000000000
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__htu__n1000000000/impactx__htu.py
