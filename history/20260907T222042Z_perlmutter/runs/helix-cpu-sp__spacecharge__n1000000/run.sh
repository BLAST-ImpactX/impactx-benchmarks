#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cpu-sp / spacecharge / n=1000000
#   status: supported   layout: 1r x 32t   env: helix   device: cpu   precision: single
