#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / fodo_exact / n=1000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__fodo_exact__n1000000/xsuite__fodo_exact.py
