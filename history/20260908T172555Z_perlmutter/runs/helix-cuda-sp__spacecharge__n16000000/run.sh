#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cuda-sp / spacecharge / n=16000000
#   status: supported   layout: 1r x 1t   env: helix-gpu   device: cuda   precision: single
...
exec pixi run --environment helix-gpu python runs/perlmutter/helix-cuda-sp__spacecharge__n16000000/helix__spacecharge.py
