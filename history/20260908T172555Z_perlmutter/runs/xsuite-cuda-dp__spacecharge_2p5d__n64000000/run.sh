#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp / spacecharge_2p5d / n=64000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp__spacecharge_2p5d__n64000000/xsuite__spacecharge_2p5d.py
