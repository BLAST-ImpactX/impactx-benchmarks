#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / htu_spin / n=16000000
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__htu_spin__n16000000/impactx__htu_spin.py
