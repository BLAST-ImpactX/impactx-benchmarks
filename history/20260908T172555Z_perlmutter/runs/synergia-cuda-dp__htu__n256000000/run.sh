#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / htu / n=256000000
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__htu__n256000000/synergia__htu.py
