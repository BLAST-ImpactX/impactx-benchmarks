#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / fodo_chromatic / n=100000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__fodo_chromatic__n100000/xsuite__fodo_chromatic.py
