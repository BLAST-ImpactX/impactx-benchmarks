#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-sp / fodo_chromatic / n=1000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-sp__fodo_chromatic__n1000000/cheetah__fodo_chromatic.py
