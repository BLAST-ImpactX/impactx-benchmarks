#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / spacecharge_2p5d / n=1000000000
#   status: failed   layout: 1r x 1t   env: synergia-cuda   device: cuda   precision: double
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__spacecharge_2p5d__n1000000000/synergia__spacecharge_2p5d.py
