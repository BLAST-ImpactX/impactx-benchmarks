#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / spacecharge / n=100000
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__spacecharge__n100000/synergia__spacecharge.py
