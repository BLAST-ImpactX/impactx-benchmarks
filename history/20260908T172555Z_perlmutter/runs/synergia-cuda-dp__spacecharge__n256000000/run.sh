#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / spacecharge / n=256000000
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__spacecharge__n256000000/synergia__spacecharge.py
