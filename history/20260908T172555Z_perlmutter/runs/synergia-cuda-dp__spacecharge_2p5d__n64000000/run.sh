#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / spacecharge_2p5d / n=64000000
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__spacecharge_2p5d__n64000000/synergia__spacecharge_2p5d.py
