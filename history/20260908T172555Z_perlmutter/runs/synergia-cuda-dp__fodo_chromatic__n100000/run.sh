#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / fodo_chromatic / n=100000
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__fodo_chromatic__n100000/synergia__fodo_chromatic.py
