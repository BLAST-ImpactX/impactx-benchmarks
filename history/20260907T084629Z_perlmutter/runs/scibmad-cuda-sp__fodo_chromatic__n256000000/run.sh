#!/usr/bin/env bash
# FAITHFUL run manifest -- scibmad-cuda-sp / fodo_chromatic / n=256000000
#   status: supported   layout: 1r x 1t   env: scibmad-gpu   device: cuda   precision: single
...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/perlmutter/scibmad-cuda-sp__fodo_chromatic__n256000000/scibmad__fodo_chromatic.jl
