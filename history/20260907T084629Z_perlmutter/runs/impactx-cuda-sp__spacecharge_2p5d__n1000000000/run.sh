#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp / spacecharge_2p5d / n=1000000000
#   status: oom   layout: 1r x 1t   env: impactx-cuda-sp   device: cuda   precision: single
...
exec pixi run --environment impactx-cuda-sp python runs/perlmutter/impactx-cuda-sp__spacecharge_2p5d__n1000000000/impactx__spacecharge_2p5d.py
