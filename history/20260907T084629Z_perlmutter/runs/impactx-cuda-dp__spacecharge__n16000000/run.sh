#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / spacecharge / n=16000000
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__spacecharge__n16000000/impactx__spacecharge.py
