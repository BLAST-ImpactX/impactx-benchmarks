#!/usr/bin/env bash
# FAITHFUL run manifest -- scibmad-cuda-sp / htu / n=1000000
...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/perlmutter/scibmad-cuda-sp__htu__n1000000/scibmad__htu.jl
