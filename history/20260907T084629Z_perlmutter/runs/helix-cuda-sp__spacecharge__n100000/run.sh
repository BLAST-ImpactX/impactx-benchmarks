#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cuda-sp / spacecharge / n=100000
...
exec pixi run --environment helix-gpu python runs/perlmutter/helix-cuda-sp__spacecharge__n100000/helix__spacecharge.py
