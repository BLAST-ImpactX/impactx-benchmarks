#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / spacecharge_2p5d / n=16000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__spacecharge_2p5d__n16000000/xsuite__spacecharge_2p5d.py
