#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / spacecharge_2p5d / n=1000000000
#   status: oom   layout: 1r x 1t   env: impactx-cuda-dp   device: cuda   precision: double
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__spacecharge_2p5d__n1000000000/impactx__spacecharge_2p5d.py
