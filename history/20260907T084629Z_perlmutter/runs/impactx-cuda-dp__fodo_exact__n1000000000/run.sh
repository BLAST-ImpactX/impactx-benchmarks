#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / fodo_exact / n=1000000000
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__fodo_exact__n1000000000/impactx__fodo_exact.py
