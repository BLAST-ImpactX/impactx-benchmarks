#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp-fm / fodo_chromatic / n=1000000000
#   status: oom   layout: 1r x 1t   env: cheetah-gpu   device: cuda   precision: double
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp-fm__fodo_chromatic__n1000000000/cheetah__fodo_chromatic.py
