#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cuda-dp / spacecharge / n=1000000
...
exec pixi run --environment helix-gpu python runs/perlmutter/helix-cuda-dp__spacecharge__n1000000/helix__spacecharge.py
