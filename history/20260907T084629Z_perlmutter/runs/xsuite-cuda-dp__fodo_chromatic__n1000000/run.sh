#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp / fodo_chromatic / n=1000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp__fodo_chromatic__n1000000/xsuite__fodo_chromatic.py
