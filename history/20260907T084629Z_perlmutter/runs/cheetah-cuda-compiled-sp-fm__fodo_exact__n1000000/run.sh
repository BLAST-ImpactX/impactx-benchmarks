#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp-fm / fodo_exact / n=1000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-sp-fm__fodo_exact__n1000000/cheetah__fodo_exact.py
