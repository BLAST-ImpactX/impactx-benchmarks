#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / htu / n=4000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__htu__n4000000/xsuite__htu.py
