#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / spacecharge_2p5d / n=100000
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__spacecharge_2p5d__n100000/impactx__spacecharge_2p5d.py
