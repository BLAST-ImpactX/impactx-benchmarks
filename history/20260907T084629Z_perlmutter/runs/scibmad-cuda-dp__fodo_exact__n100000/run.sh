#!/usr/bin/env bash
# FAITHFUL run manifest -- scibmad-cuda-dp / fodo_exact / n=100000
...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/perlmutter/scibmad-cuda-dp__fodo_exact__n100000/scibmad__fodo_exact.jl
