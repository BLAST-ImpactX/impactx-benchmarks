#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-dp-fm / spacecharge / n=1000000
#   status: supported   layout: 1r x 8t   env: cheetah   device: cpu   precision: double
