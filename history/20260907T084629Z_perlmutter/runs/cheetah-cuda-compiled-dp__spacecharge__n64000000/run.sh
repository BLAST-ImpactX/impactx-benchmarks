#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp / spacecharge / n=64000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp__spacecharge__n64000000/cheetah__spacecharge.py
