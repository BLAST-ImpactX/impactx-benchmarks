...
#   status: supported   layout: 1r x 4t   env: impactx-sp   device: cpu   precision: single
...
exec pixi run --environment impactx-sp taskset -c 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-sp__spacecharge_2p5d__n1000/impactx__spacecharge_2p5d.py
