...
# MatrixKick = matrix-kick-matrix, a 2nd-order SYMPLECTIC integrator of the EXACT quad
# Hamiltonian (the kick applies the exact non-paraxial Ps=sqrt((1+dz)^2-Px^2-Py^2)
# correction), plus the exact_drift -> native exact (non-paraxial) FODO model.
...
v0 = zeros(Float32, NPART, 6)  # SP/DP via cfg.precision
