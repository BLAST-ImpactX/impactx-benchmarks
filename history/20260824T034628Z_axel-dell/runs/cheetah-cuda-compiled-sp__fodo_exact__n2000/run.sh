#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp / fodo_exact / n=2000
#   status: failed   layout: 1r x 1t   env: cheetah-gpu   device: cuda   precision: single
...
exec pixi run --environment cheetah-gpu python runs/axel-dell/cheetah-cuda-compiled-sp__fodo_exact__n2000/cheetah__fodo_exact.py
