#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-sp / spacecharge / n=1000000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-sp__spacecharge__n1000000/cheetah__spacecharge.py
