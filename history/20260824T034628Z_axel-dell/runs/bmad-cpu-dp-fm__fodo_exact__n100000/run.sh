#!/usr/bin/env bash
# FAITHFUL run manifest -- bmad-cpu-dp-fm / fodo_exact / n=100000
...
exec pixi run --environment bmad-fm taskset -c 0 /home/axel/src/impactx-benchmarks/codes/bmad/bmad_driver runs/axel-dell/bmad-cpu-dp-fm__fodo_exact__n100000/bmad__fodo_exact.in
