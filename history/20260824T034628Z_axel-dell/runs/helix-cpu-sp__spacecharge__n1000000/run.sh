...
#   status: supported   layout: 1r x 4t   env: helix   device: cpu   precision: single
...
exec pixi run --environment helix taskset -c 0,2,4,6 python runs/axel-dell/helix-cpu-sp__spacecharge__n1000000/helix__spacecharge.py
