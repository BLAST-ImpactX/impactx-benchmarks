#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-dp / fodo_chromatic / n=10000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-dp__fodo_chromatic__n10000/cheetah__fodo_chromatic.py
