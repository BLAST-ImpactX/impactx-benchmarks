#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-sp / fodo_exact / n=100000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-sp__fodo_exact__n100000/cheetah__fodo_exact.py
