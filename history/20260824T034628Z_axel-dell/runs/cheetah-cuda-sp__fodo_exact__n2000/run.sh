#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-sp / fodo_exact / n=2000
...
exec pixi run --environment cheetah-gpu python runs/axel-dell/cheetah-cuda-sp__fodo_exact__n2000/cheetah__fodo_exact.py
