#!/usr/bin/env bash
# FAITHFUL run manifest -- elegant-cuda-dp / htu_spin / n=100000
...
exec pixi run --environment elegant-gpu python /home/axel/src/impactx-benchmarks/codes/elegant/driver.py runs/axel-dell/elegant-cuda-dp__htu_spin__n100000/elegant__htu_spin.ele --ranks 1 --threads 1 --cpus 0,2,4,6 --device cuda
