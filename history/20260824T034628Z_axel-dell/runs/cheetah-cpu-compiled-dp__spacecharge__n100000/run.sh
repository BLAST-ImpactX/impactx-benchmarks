#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-dp / spacecharge / n=100000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-dp__spacecharge__n100000/cheetah__spacecharge.py
