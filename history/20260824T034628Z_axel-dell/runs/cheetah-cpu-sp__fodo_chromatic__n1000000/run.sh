#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-sp / fodo_chromatic / n=1000000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-sp__fodo_chromatic__n1000000/cheetah__fodo_chromatic.py
