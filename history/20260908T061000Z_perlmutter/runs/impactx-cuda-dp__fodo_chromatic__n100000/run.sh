#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / fodo_chromatic / n=100000
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__fodo_chromatic__n100000/impactx__fodo_chromatic.py
