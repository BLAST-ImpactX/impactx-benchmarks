#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cpu-sp / spacecharge / n=100000
#   status: supported   layout: 1r x 16t   env: helix   device: cpu   precision: single
