#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / fodo_exact / n=256000000
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__fodo_exact__n256000000/synergia__fodo_exact.py
