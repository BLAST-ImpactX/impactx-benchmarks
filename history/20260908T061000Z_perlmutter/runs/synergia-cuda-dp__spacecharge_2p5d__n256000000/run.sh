#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / spacecharge_2p5d / n=256000000
#   status: supported   layout: 1r x 1t   env: synergia-cuda   device: cuda   precision: double
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__spacecharge_2p5d__n256000000/synergia__spacecharge_2p5d.py
