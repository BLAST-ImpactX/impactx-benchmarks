#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-dp / fodo_chromatic / n=64000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-dp__fodo_chromatic__n64000000/cheetah__fodo_chromatic.py
