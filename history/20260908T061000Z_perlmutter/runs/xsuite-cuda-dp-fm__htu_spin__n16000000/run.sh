#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / htu_spin / n=16000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__htu_spin__n16000000/xsuite__htu_spin.py
