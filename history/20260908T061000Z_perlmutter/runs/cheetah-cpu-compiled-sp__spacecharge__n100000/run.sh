#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-sp / spacecharge / n=100000
#   status: supported   layout: 1r x 16t   env: cheetah   device: cpu   precision: single
