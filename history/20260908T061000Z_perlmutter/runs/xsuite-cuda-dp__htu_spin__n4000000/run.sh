#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp / htu_spin / n=4000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp__htu_spin__n4000000/xsuite__htu_spin.py
