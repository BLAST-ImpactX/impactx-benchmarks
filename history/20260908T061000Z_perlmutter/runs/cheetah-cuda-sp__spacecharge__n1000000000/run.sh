#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-sp / spacecharge / n=1000000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-sp__spacecharge__n1000000000/cheetah__spacecharge.py
