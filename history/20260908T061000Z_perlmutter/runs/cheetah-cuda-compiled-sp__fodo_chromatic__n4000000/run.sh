#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp / fodo_chromatic / n=4000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-sp__fodo_chromatic__n4000000/cheetah__fodo_chromatic.py
