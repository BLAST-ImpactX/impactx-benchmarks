#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-dp / spacecharge / n=256000000
...
exec pixi run --environment impactx-cuda-dp python runs/perlmutter/impactx-cuda-dp__spacecharge__n256000000/impactx__spacecharge.py
