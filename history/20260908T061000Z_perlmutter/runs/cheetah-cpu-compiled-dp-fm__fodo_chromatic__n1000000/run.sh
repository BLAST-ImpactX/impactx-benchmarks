#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-dp-fm / fodo_chromatic / n=1000000
#   status: supported   layout: 1r x 32t   env: cheetah   device: cpu   precision: double
