#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp / htu / n=4000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-sp__htu__n4000000/cheetah__htu.py
