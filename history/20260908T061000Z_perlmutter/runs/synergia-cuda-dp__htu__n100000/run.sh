#!/usr/bin/env bash
# FAITHFUL run manifest -- synergia-cuda-dp / htu / n=100000
...
exec pixi run --environment synergia-cuda python runs/perlmutter/synergia-cuda-dp__htu__n100000/synergia__htu.py
