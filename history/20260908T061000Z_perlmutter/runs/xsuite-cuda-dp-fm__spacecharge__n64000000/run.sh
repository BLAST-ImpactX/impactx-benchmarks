#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / spacecharge / n=64000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__spacecharge__n64000000/xsuite__spacecharge.py
