...
exec pixi run --environment elegant-gpu python /home/axel/src/impactx-benchmarks/codes/elegant/driver.py runs/axel-dell/elegant-cuda-dp__htu__n4000000/elegant__htu.ele --ranks 1 --threads 1 --cpus 0,2,4,6 --device cuda
