#!/usr/bin/env bash
# FAITHFUL run manifest -- bmad-cpu-dp-fm / fodo_chromatic / n=1000
#   status: failed   layout: 1r x 1t   env: bmad-fm   device: cpu   precision: double
...
exec pixi run --environment bmad-fm taskset -c 0 /home/axel/src/impactx-benchmarks/codes/bmad/bmad_driver runs/axel-dell/bmad-cpu-dp-fm__fodo_chromatic__n1000/bmad__fodo_chromatic.in
