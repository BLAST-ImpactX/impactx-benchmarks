#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-sp-fm / htu / n=1000000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-sp-fm__htu__n1000000/cheetah__htu.py
