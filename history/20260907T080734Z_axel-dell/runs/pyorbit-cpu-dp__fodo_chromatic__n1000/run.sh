...
exec pixi run --environment pyorbit mpirun -np 4 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 1 0,2,4,6 python runs/axel-dell/pyorbit-cpu-dp__fodo_chromatic__n1000/pyorbit__fodo_chromatic.py
