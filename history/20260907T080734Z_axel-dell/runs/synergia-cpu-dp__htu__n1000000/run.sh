...
#   status: supported   layout: 2r x 2t   env: synergia   device: cpu   precision: double
...
exec pixi run --environment synergia mpirun -np 2 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 2 0,2,4,6 python runs/axel-dell/synergia-cpu-dp__htu__n1000000/synergia__htu.py
