...
exec pixi run --environment scibmad taskset -c 0,2,4,6 julia -t2 --project=codes/scibmad runs/axel-dell/scibmad-cpu-dp__fodo_chromatic__n1000/scibmad__fodo_chromatic.jl
