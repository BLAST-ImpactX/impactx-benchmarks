...
#   status: supported   layout: 1r x 4t   env: helix   device: cpu   precision: double
...
exec pixi run --environment helix taskset -c 0,2,4,6 python runs/axel-dell/helix-cpu-dp__spacecharge__n1000000/helix__spacecharge.py
