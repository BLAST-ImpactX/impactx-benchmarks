...
exec pixi run --environment impactx-sp mpirun -np 4 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 1 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-sp__fodo_chromatic__n100000/impactx__fodo_chromatic.py
