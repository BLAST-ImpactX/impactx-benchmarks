...
#   status: supported   layout: 1r x 1t   env: pyat   device: cpu   precision: double
...
exec pixi run --environment pyat taskset -c 0,2,4,6 python runs/axel-dell/pyat-cpu-dp__fodo_chromatic__n1000/pyat__fodo_chromatic.py
