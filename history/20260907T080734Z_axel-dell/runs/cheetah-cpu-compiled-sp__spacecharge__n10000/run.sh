#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-sp / spacecharge / n=10000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-sp__spacecharge__n10000/cheetah__spacecharge.py
