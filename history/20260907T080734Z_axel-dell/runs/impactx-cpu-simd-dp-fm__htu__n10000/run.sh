...
exec pixi run --environment impactx-fm mpirun -np 4 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 1 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-dp-fm__htu__n10000/impactx__htu.py
