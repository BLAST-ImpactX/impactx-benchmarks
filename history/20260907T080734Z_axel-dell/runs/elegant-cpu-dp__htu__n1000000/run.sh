...
exec pixi run --environment elegant python /home/axel/src/impactx-benchmarks/codes/elegant/driver.py runs/axel-dell/elegant-cpu-dp__htu__n1000000/elegant__htu.ele --ranks 4 --threads 1 --cpus 0,2,4,6 --device cpu
