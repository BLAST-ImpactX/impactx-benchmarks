#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-sp-fm / fodo_chromatic / n=1000
#   status: supported   layout: 1r x 2t   env: cheetah   device: cpu   precision: single
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-sp-fm__fodo_chromatic__n1000/cheetah__fodo_chromatic.py
