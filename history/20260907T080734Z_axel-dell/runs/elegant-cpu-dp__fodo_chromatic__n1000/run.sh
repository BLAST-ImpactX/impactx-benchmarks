...
#   status: supported   layout: 2r x 1t   env: elegant   device: cpu   precision: double
...
exec pixi run --environment elegant python /home/axel/src/impactx-benchmarks/codes/elegant/driver.py runs/axel-dell/elegant-cpu-dp__fodo_chromatic__n1000/elegant__fodo_chromatic.ele --ranks 2 --threads 1 --cpus 0,2,4,6 --device cpu
