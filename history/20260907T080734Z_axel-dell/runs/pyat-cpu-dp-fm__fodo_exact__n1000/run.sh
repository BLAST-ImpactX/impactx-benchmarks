...
#   status: supported   layout: 1r x 2t   env: pyat-fm   device: cpu   precision: double
...
exec pixi run --environment pyat-fm taskset -c 0,2,4,6 python runs/axel-dell/pyat-cpu-dp-fm__fodo_exact__n1000/pyat__fodo_exact.py
