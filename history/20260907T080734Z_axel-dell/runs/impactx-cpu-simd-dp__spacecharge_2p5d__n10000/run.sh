...
#   status: supported   layout: 1r x 4t   env: impactx   device: cpu   precision: double
...
exec pixi run --environment impactx taskset -c 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-dp__spacecharge_2p5d__n10000/impactx__spacecharge_2p5d.py
