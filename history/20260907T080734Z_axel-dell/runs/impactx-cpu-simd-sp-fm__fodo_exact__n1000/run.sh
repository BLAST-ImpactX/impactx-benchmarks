...
exec pixi run --environment impactx-sp-fm mpirun -np 4 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 1 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-sp-fm__fodo_exact__n1000/impactx__fodo_exact.py
