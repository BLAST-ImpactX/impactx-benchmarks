#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cpu-simd-sp-fm / spacecharge / n=10000
...
exec pixi run --environment impactx-sp-fm taskset -c 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-sp-fm__spacecharge__n10000/impactx__spacecharge.py
