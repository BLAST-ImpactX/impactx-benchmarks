#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-sp-fm / spacecharge / n=1000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-sp-fm__spacecharge__n1000/cheetah__spacecharge.py
