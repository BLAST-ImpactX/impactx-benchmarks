...
#   status: supported   layout: 1r x 2t   env: scibmad   device: cpu   precision: single
...
exec pixi run --environment scibmad taskset -c 0,2,4,6 julia -t2 --project=codes/scibmad runs/axel-dell/scibmad-cpu-sp__fodo_chromatic__n10000/scibmad__fodo_chromatic.jl
