#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cpu-simd-sp-fm / spacecharge_2p5d / n=100000
...
exec pixi run --environment impactx-sp-fm mpirun -np 4 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 1 0,2,4,6 python runs/axel-dell/impactx-cpu-simd-sp-fm__spacecharge_2p5d__n100000/impactx__spacecharge_2p5d.py
