...
#   status: supported   layout: 4r x 1t   env: synergia   device: cpu   precision: double
...
exec pixi run --environment synergia mpirun -np 4 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 1 0,2,4,6 python runs/axel-dell/synergia-cpu-dp__spacecharge_2p5d__n1000000/synergia__spacecharge_2p5d.py
