#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp / fodo_exact / n=2000
...
exec pixi run --environment impactx-cuda-sp python runs/axel-dell/impactx-cuda-sp__fodo_exact__n2000/impactx__fodo_exact.py
