...
exec pixi run --environment bmad taskset -c 0,2,4,6 /home/axel/src/impactx-benchmarks/codes/bmad/bmad_driver runs/axel-dell/bmad-cpu-dp__fodo_chromatic__n1000/bmad__fodo_chromatic.in
