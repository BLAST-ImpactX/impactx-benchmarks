#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cpu-dp / htu_spin / n=2000
...
exec pixi run --environment xsuite taskset -c 0,2,4,6 python runs/axel-dell/xsuite-cpu-dp__htu_spin__n2000/xsuite__htu_spin.py
