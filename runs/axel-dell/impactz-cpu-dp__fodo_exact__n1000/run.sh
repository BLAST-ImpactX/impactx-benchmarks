...
exec pixi run --environment impactz python /home/axel/src/impactx-benchmarks/codes/impactz/driver.py runs/axel-dell/impactz-cpu-dp__fodo_exact__n1000/impactz__fodo_exact.in --ranks 1 --threads 1 --cpus 0,2,4,6 --device cpu
