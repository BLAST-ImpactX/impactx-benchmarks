#!/usr/bin/env bash
# FAITHFUL run manifest -- pyat-cpu-dp / fodo_exact / n=2000
#   status: supported   layout: 1r x 2t   env: pyat   device: cpu   precision: double
...
exec pixi run --environment pyat taskset -c 0,2,4,6 python runs/axel-dell/pyat-cpu-dp__fodo_exact__n2000/pyat__fodo_exact.py
