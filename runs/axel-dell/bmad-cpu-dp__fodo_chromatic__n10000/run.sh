...
#   status: supported   layout: 1r x 2t   env: bmad   device: cpu   precision: double
...
exec pixi run --environment bmad taskset -c 0,2,4,6 /home/axel/src/impactx-benchmarks/codes/bmad/bmad_driver runs/axel-dell/bmad-cpu-dp__fodo_chromatic__n10000/bmad__fodo_chromatic.in
