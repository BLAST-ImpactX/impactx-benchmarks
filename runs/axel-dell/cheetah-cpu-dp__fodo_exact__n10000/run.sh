#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-dp / fodo_exact / n=10000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-dp__fodo_exact__n10000/cheetah__fodo_exact.py
