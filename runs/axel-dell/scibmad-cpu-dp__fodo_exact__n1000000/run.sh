...
exec pixi run --environment scibmad taskset -c 0,2,4,6 julia -t4 --project=codes/scibmad runs/axel-dell/scibmad-cpu-dp__fodo_exact__n1000000/scibmad__fodo_exact.jl
