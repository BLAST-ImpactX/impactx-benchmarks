...
exec pixi run --environment impactz python /home/axel/src/impactx-benchmarks/codes/impactz/driver.py runs/axel-dell/impactz-cpu-dp__spacecharge__n10000/impactz__spacecharge.in --ranks 4 --threads 1 --cpus 0,2,4,6 --device cpu
