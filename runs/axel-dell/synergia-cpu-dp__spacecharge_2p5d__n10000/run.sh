...
#   status: supported   layout: 1r x 4t   env: synergia   device: cpu   precision: double
...
exec pixi run --environment synergia taskset -c 0,2,4,6 python runs/axel-dell/synergia-cpu-dp__spacecharge_2p5d__n10000/synergia__spacecharge_2p5d.py
