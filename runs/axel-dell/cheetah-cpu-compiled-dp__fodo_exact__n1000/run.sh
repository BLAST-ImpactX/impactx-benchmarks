#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-dp / fodo_exact / n=1000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-dp__fodo_exact__n1000/cheetah__fodo_exact.py
