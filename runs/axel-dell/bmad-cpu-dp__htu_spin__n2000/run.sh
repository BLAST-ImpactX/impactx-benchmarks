#!/usr/bin/env bash
# FAITHFUL run manifest -- bmad-cpu-dp / htu_spin / n=2000
...
exec pixi run --environment bmad taskset -c 0,2,4,6 /home/axel/src/impactx-benchmarks/codes/bmad/bmad_driver runs/axel-dell/bmad-cpu-dp__htu_spin__n2000/bmad__htu_spin.in
