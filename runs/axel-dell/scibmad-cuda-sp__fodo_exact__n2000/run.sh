#!/usr/bin/env bash
# FAITHFUL run manifest -- scibmad-cuda-sp / fodo_exact / n=2000
...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/axel-dell/scibmad-cuda-sp__fodo_exact__n2000/scibmad__fodo_exact.jl
