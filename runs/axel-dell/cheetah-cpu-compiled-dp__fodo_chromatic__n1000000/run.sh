...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-dp__fodo_chromatic__n1000000/cheetah__fodo_chromatic.py
