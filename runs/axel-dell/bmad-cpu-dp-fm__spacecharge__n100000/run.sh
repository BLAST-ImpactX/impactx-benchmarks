#!/usr/bin/env bash
# FAITHFUL run manifest -- bmad-cpu-dp-fm / spacecharge / n=100000
#   status: supported   layout: 1r x 1t   env: bmad-fm   device: cpu   precision: double
...
exec pixi run --environment bmad-fm taskset -c 0 /home/axel/src/impactx-benchmarks/codes/bmad/bmad_driver runs/axel-dell/bmad-cpu-dp-fm__spacecharge__n100000/bmad__spacecharge.in
