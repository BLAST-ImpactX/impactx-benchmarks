#!/usr/bin/env bash
# FAITHFUL run manifest -- elegant-cpu-dp / htu_spin / n=1000000
...
exec pixi run --environment elegant python /home/axel/src/impactx-benchmarks/codes/elegant/driver.py runs/axel-dell/elegant-cpu-dp__htu_spin__n1000000/elegant__htu_spin.ele --ranks 4 --threads 1 --cpus 0,2,4,6 --device cpu
