...
exec pixi run --environment synergia mpirun -np 4 -bind-to none /home/axel/src/impactx-benchmarks/codes/pin_rank.sh 1 0,2,4,6 python runs/axel-dell/synergia-cpu-dp__htu__n1000/synergia__htu.py
