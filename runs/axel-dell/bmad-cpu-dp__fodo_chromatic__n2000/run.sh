#!/usr/bin/env bash
# FAITHFUL run manifest -- bmad-cpu-dp / fodo_chromatic / n=2000
...
exec pixi run --environment bmad taskset -c 0 /home/axel/src/impactx-benchmarks/codes/bmad/bmad_driver runs/axel-dell/bmad-cpu-dp__fodo_chromatic__n2000/bmad__fodo_chromatic.in
