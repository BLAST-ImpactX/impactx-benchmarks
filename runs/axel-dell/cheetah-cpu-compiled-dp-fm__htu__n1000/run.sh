#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-dp-fm / htu / n=1000
...
exec pixi run --environment cheetah taskset -c 0,2,4,6 python runs/axel-dell/cheetah-cpu-compiled-dp-fm__htu__n1000/cheetah__htu.py
