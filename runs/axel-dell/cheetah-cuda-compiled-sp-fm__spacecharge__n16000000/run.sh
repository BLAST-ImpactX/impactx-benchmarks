#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp-fm / spacecharge / n=16000000
...
exec pixi run --environment cheetah-gpu python runs/axel-dell/cheetah-cuda-compiled-sp-fm__spacecharge__n16000000/cheetah__spacecharge.py
