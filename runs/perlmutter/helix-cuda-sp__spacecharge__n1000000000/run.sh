#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cuda-sp / spacecharge / n=1000000000
#   status: failed   layout: 1r x 1t   env: helix-gpu   device: cuda   precision: single
...
exec pixi run --environment helix-gpu python runs/perlmutter/helix-cuda-sp__spacecharge__n1000000000/helix__spacecharge.py
