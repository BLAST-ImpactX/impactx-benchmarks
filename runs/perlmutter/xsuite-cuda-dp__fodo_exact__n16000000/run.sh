#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp / fodo_exact / n=16000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp__fodo_exact__n16000000/xsuite__fodo_exact.py
