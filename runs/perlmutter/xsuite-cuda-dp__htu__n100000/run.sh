#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp / htu / n=100000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp__htu__n100000/xsuite__htu.py
