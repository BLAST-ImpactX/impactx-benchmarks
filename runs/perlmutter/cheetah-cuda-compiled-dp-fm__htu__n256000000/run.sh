#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp-fm / htu / n=256000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp-fm__htu__n256000000/cheetah__htu.py
