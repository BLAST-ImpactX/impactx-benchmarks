#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp-fm / htu / n=100000
...
exec pixi run --environment impactx-cuda-sp-fm python runs/perlmutter/impactx-cuda-sp-fm__htu__n100000/impactx__htu.py
