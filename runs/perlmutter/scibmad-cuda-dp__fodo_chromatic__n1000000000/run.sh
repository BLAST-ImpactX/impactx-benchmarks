#!/usr/bin/env bash
# FAITHFUL run manifest -- scibmad-cuda-dp / fodo_chromatic / n=1000000000
#   status: failed   layout: 1r x 1t   env: scibmad-gpu   device: cuda   precision: double
...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/perlmutter/scibmad-cuda-dp__fodo_chromatic__n1000000000/scibmad__fodo_chromatic.jl
