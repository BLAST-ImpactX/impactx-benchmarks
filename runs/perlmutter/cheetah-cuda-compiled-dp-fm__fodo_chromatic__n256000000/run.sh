#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp-fm / fodo_chromatic / n=256000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp-fm__fodo_chromatic__n256000000/cheetah__fodo_chromatic.py
