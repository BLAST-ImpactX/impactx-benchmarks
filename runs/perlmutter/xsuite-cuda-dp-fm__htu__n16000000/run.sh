#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp-fm / htu / n=16000000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp-fm__htu__n16000000/xsuite__htu.py
