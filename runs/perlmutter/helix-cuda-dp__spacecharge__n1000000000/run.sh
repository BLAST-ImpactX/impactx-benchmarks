#!/usr/bin/env bash
# FAITHFUL run manifest -- helix-cuda-dp / spacecharge / n=1000000000
#   status: failed   layout: 1r x 1t   env: helix-gpu   device: cuda   precision: double
...
exec pixi run --environment helix-gpu python runs/perlmutter/helix-cuda-dp__spacecharge__n1000000000/helix__spacecharge.py
