#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cpu-compiled-sp-fm / fodo_chromatic / n=10000
#   status: supported   layout: 1r x 8t   env: cheetah   device: cpu   precision: single
