#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp / htu / n=16000000
...
exec pixi run --environment impactx-cuda-sp python runs/perlmutter/impactx-cuda-sp__htu__n16000000/impactx__htu.py
