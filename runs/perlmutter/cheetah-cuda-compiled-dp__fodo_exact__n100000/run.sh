#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp / fodo_exact / n=100000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp__fodo_exact__n100000/cheetah__fodo_exact.py
