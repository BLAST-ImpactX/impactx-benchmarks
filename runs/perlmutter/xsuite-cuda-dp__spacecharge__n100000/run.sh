#!/usr/bin/env bash
# FAITHFUL run manifest -- xsuite-cuda-dp / spacecharge / n=100000
...
exec pixi run --environment xsuite-gpu python runs/perlmutter/xsuite-cuda-dp__spacecharge__n100000/xsuite__spacecharge.py
