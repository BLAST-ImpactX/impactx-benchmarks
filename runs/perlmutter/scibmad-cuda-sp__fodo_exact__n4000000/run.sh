#!/usr/bin/env bash
# FAITHFUL run manifest -- scibmad-cuda-sp / fodo_exact / n=4000000
...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/perlmutter/scibmad-cuda-sp__fodo_exact__n4000000/scibmad__fodo_exact.jl
