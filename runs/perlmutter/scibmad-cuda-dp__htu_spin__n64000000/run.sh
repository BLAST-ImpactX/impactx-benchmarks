#!/usr/bin/env bash
# FAITHFUL run manifest -- scibmad-cuda-dp / htu_spin / n=64000000
...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/perlmutter/scibmad-cuda-dp__htu_spin__n64000000/scibmad__htu_spin.jl
