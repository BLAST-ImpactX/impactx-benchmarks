#!/usr/bin/env bash
# FAITHFUL run manifest -- scibmad-cuda-sp / fodo_chromatic / n=100000
...
exec pixi run --environment scibmad-gpu julia -t1 --project=codes/scibmad-gpu runs/perlmutter/scibmad-cuda-sp__fodo_chromatic__n100000/scibmad__fodo_chromatic.jl
