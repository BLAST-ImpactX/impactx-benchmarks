#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp-fm / spacecharge_2p5d / n=1000000000
#   status: failed   layout: 1r x 1t   env: impactx-cuda-sp-fm   device: cuda   precision: single
...
exec pixi run --environment impactx-cuda-sp-fm python runs/perlmutter/impactx-cuda-sp-fm__spacecharge_2p5d__n1000000000/impactx__spacecharge_2p5d.py
