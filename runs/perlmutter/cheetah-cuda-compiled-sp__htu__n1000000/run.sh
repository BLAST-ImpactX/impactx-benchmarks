#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-sp / htu / n=1000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-sp__htu__n1000000/cheetah__htu.py
