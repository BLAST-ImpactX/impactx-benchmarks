#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp / fodo_exact / n=64000000
...
exec pixi run --environment impactx-cuda-sp python runs/perlmutter/impactx-cuda-sp__fodo_exact__n64000000/impactx__fodo_exact.py
