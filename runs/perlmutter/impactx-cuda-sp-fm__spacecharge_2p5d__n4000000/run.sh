#!/usr/bin/env bash
# FAITHFUL run manifest -- impactx-cuda-sp-fm / spacecharge_2p5d / n=4000000
...
exec pixi run --environment impactx-cuda-sp-fm python runs/perlmutter/impactx-cuda-sp-fm__spacecharge_2p5d__n4000000/impactx__spacecharge_2p5d.py
