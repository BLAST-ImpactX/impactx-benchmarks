#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-sp / fodo_exact / n=256000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-sp__fodo_exact__n256000000/cheetah__fodo_exact.py
