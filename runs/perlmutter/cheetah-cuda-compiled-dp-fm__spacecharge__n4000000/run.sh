#!/usr/bin/env bash
# FAITHFUL run manifest -- cheetah-cuda-compiled-dp-fm / spacecharge / n=4000000
...
exec pixi run --environment cheetah-gpu python runs/perlmutter/cheetah-cuda-compiled-dp-fm__spacecharge__n4000000/cheetah__spacecharge.py
